...
savedir = 'C:\Users\zwang39\OneDrive - George Mason University - O365 Production\Paper(EM)\AISTAT 2021\DA example';

pauseinterval=10;

for j=range
    jobnames{j} = ['experiment_DA' '(' num2str(j) ')']; 
    filenames{j} = ['results_experiment_DA_' num2str(j) '.mat'];
end
