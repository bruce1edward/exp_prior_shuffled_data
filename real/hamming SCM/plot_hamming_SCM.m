...
%export_fig('ftp_sparse_ree.pdf')
export_fig('scm_sparse_ree.pdf')
%export_fig('plot/lm_sparse_ree.pdf')
%export_fig('plot/glm_sparse_ree.pdf')
%export_fig('plot/sparse_ree_wine.pdf')
